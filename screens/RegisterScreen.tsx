...
export default function RegisterScreen({navigation}:any) {
  ...
  function registro() {
    createUserWithEmailAndPassword(auth, correo, contrasenia)
      ...
      .catch((error) => {
        ...
        Alert.alert("Error al registrar, revisa los datos ingresados", errorMessage);
        // ..
      });
  }
  ...
  return (
     <View style={styles.container}>
       <Text style={{fontSize:30, fontWeight:'bold', padding:10}}>Registrate Ahora</Text>
       <Image
               source={{
               ...
               style={styles.img}
             />
       <Text style={{fontSize:20, padding:15, textAlign:'center'}}>Unete a nuestra gran comunidad de jugadores, guardas tus puntuaciones y conoce tus estadisticas.</Text>
